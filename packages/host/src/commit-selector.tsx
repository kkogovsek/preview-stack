...
export function CommitSelector() {
  ...
  return (
    <div className="inline-block text-left fixed bottom-2 right-[21vw] z-40">
      ...
      {menuOpen && (
        <div
          className="absolute right-0 bottom-12 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none max-h-72 overflow-y-auto"
          role="menu"
